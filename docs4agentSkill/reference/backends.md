...
1. **Formula**: Normalized ASCII molecular formula.
1. **Relative Atomic Mass**: Numerical mass value.
1. **SMILES**: Canonical structural string.
1. **Molecular Image**: Visual 2D structure (where available; placeholder used otherwise).
